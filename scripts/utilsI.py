...
class Writer(object):
    def __init__(self, env, seed, weight, epoch, prior, traj_size, fname='', folder='PU_log', pbound='0.0', noise=0.0, cutype='cu'):
        if weight: 
            label = '_weight'
        else: 
            label = ''
        ...
        self.fname = '{}_{}{}_{}{}_{}{}{}{}_{}.csv'.format(env, seed, label, epoch, plabel, traj_size, pblabel, fname, nlabel, cutype)
        self.folder = folder
